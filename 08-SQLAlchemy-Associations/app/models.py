...
class Owner(Base):
    ...
    #we are tying the owner's table and pet's table together, by using backref
...
#2.✅ Update your migrations by running `alembic revision --autogenerate -m "add pet / owner tables"` and `alembic upgrade head` 
