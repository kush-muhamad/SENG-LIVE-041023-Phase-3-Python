...
#5.✅ Add Delete methods for Job and Handler
    ...
    cat_breeds = ["Domestic Long Hair", "Domestic Short Hair", "Siamese", "Persian cat", "Sphynx cat"]
   
    #Create an array of dog breeds
    dog_breeds = ["Golden Doodle", "Poodle", "Golden Retriever", "Chihuahua", "Samoyed"]
    ...
    for _ in range(50):
        ...
        #these are built in methods from FAKER
...
#5.✅ Create a empty array set to handlers
    ...
    for _ in range(50):
        ...
        handler = Handler(
            ...
            email=fake.email(),
            phone=random.randint(1000000000, 9999999999),
            hourly_rate=random.uniform(20, 70)
        )
